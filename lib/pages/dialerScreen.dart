...
import 'package:madadkaronlineapp/classes/hami.dart';
import 'package:madadkaronlineapp/classes/madadkar.dart';
import 'package:madadkaronlineapp/globals.dart';
import 'package:madadkaronlineapp/pages/callScreen.dart';
import 'package:madadkaronlineapp/style/theme.dart' as Theme;
                                        ...
                                        children: <Widget>[
                                          Row(
                                            ...
                                            children: <Widget>[
                                              new Container(
                                                child: new Text(
                                                    '${s[index].hamiFName} ${s[index].hamiLName}'),
                                              ),
                                            ],
                                          ),
                                          Row(
